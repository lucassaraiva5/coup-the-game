        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h2 class="mb-0">Edit Partner Store</h2>
                    <a href="{{ route('partner-stores.index') }}" class="btn btn-secondary">Back to List</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('partner-stores.update', $partnerStore) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="name" 
                                   name="name" 
                                   value="{{ old('name', $partnerStore->name) }}" 
                                   required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" 
                                   ...
                                   id="product_link" 
                                   name="product_link" 
                                   value="{{ old('product_link', $partnerStore->product_link) }}" 
